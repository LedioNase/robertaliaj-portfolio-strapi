...
export interface ApiArtworkArtwork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mainMedia: Schema.Attribute.DynamicZone<
      [
        'portfolio.video-media',
        'portfolio.image-media',
        'portfolio.external-video',
      ]
    > &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    otherMedia: Schema.Attribute.DynamicZone<
      [
        'portfolio.video-media',
        'portfolio.image-media',
        'portfolio.external-video',
    ...
    >;
    previewImage: Schema.Attribute.Component<'portfolio.preview-image', false>;
    publishedAt: Schema.Attribute.DateTime;
